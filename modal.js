const worksData = {
  ...
  desktopTitle: ['REL 2022', 'Multi-Post Stories', 'Facebook 360', 'Uber navigation'],
  cardDetail1: ['REL', 'FACEBOOK', 'FACEBOOK', 'UBER'],
  cardDetail2: ['REL', 'Canopy', 'Canopy', 'Canopy'],
  cardDetail4: ['Front End Dev', 'Back End Dev', 'Back End Dev', 'Back End Dev'],
  cardDetail6: ['2022', '2015', '2015', '2015'],
  mobileTitle: ['REL 2022', 'Multi-Post Stories', 'Tonic', 'Multi-Post Stories'],
  desktopDescription: ['One of the major professional gaming events in the world with top players from across the globe competing against each other for the Romania Esports League CUP', 'Experimental content creation feature that allows users to add to an existing story over the course of the day without spamming theri friends', 'Exploring the future of media in Facebook first Virtual Reality app; a place to discover and enjoy 360 photos and videos on Gear VR', 'A smart assistant to make driving more safe, efficient and more fun by unlocking your most expensive computer, your car'],
  mobileDescription: ['One of the major professional gaming events in the world with top players from across the globe competing against each other for the Romania Esports League CUP', 'A daily selection of privately personalized reads; no accounts or sign-ups required', 'A daily selection of privately personalized reads; no accounts or sign-ups required', 'A daily selection of privately personalized reads; no accounts or sign-ups required'],
